...
resource "aws_iam_role_policy" "ecs_secrets" {
  ...
  policy = jsonencode({
    ...
    Statement = [{
      ...
      Resource = ["arn:aws:secretsmanager:${var.aws_region}:${data.aws_caller_identity.current.account_id}:secret:api/production/*"]
    }]
  })
}
